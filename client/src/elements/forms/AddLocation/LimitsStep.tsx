...
import type { Limits } from '@idemand/common';
import { AllowString, limitsValidationNested } from 'common';
        ...
        <Form onSubmit={handleSubmit}>
          <Box sx={{ py: 5 }}>
            <Typography color='text.secondary' gutterBottom>
              Please choose your limits. The prefilled values are based on a
              percentage of the estimated building replacement cost. Feel free
              to edit.
            </Typography>
